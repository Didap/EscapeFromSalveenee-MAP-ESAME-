...
//       
        ...
        for(int x=0;x<xlength;x++){
            for(int y=0;y<ylength;y++){
                ...
                if(grid[x][y] == '2'){
                   areas.add(new Area(x,y,"Sala Conferenze"));
                   grid[x][y]='.';
                }
                if(grid[x][y] == '3'){
                   areas.add(new Area(x,y,"Quartier generale"));
                   grid[x][y]='.';
                }
                if(grid[x][y] == '4'){
                   areas.add(new Area(x,y,"Area emergenze"));
                   grid[x][y]='.';
                }
                if(grid[x][y] == '5'){
                   areas.add(new Area(x,y,"Scafo cargo"));
                   grid[x][y]='.';
                }
                if(grid[x][y] == '6'){
                   areas.add(new Area(x,y,"Cella mezza scassata"));
                   grid[x][y]='.';
                }
                if(grid[x][y] == '7'){
                   areas.add(new Area(x,y,"Centro di controllo"));
                   grid[x][y]='.';
                }
                if(grid[x][y] == '8'){
                   areas.add(new Area(x,y,"Area comune"));
                   grid[x][y]='.';
                }
                if(grid[x][y] == '9'){
                   areas.add(new Area(x,y,"Quartier generale"));
                ...
                if(grid[x][y] == 'y'){
                   areas.add(new Area(x,y,"Cucina"));
                   grid[x][y]='.';
                }
                if(grid[x][y] == 'g'){
                   areas.add(new Area(x,y,"Centro di sicurezza"));
                   grid[x][y]='.';
                }
